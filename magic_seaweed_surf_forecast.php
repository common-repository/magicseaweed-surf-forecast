<?php
/**
 * Plugin Name: MagicSeaWeed Surf Forecast	
 * Plugin URI: http://www.maxssite.com/MagicSeaWeed-Surf-Forecast/
...
class Surf_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '<link href="/wp-content/plugins/magicseaweed-surf-forecast/includes/surf_report.css" rel="stylesheet" type="text/css">';
